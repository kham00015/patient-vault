...
const updateSchema = z.object({
  ...
  primaryInsurancePayerId: z.string().max(100).optional(),
  primaryInsuranceClaimAddressLine1: z.string().max(200).optional(),
  primaryInsuranceClaimAddressLine2: z.string().max(200).optional(),
  primaryInsuranceClaimCity: z.string().max(100).optional(),
  primaryInsuranceClaimState: z.string().max(2).optional(),
  primaryInsuranceClaimZip: z.string().max(10).optional(),
  secondaryInsuranceCarrier: z.string().max(150).optional(),
  secondaryInsuranceMemberId: z.string().max(100).optional(),
  secondaryInsuranceGroupNumber: z.string().max(100).optional(),
  secondaryInsurancePayerId: z.string().max(100).optional(),
  secondaryInsuranceClaimAddressLine1: z.string().max(200).optional(),
  secondaryInsuranceClaimAddressLine2: z.string().max(200).optional(),
  secondaryInsuranceClaimCity: z.string().max(100).optional(),
  secondaryInsuranceClaimState: z.string().max(2).optional(),
  secondaryInsuranceClaimZip: z.string().max(10).optional(),
